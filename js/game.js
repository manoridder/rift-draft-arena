...
/* Ten distinct escalating rank emblems, built per rank index. GEM is the centerpiece color,
   RANKCOL is reused as the rim/glow color. Display only, supersedes the static SPEC-topbar shield. */
